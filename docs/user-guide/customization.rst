...
This configuration file in a platform specific directory, which you can see the path for by running::
  ...
  >>> hermes_nemisis.print_config()  # doctest: +SKIP
...
the package. Settings can be modified directly, for example::
    ...
    import hermes_nemisis
    hermes_nemisis.config.set('downloads', 'download_dir', '/home/user/Downloads')
...
.. literalinclude:: ../../hermes_nemisis/data/configrc